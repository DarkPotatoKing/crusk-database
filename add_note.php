...
<body>
    ...
    <?php
        ...
        {
            if ($stmt = $conn->prepare("INSERT INTO Notes (note, stalker_username, crusk_student_number) VALUES (?, ?, ?)"))
            {
                /* bind parameters for markers */
                $stmt->bind_param("sss", $_POST["note"], $_SESSION["username"], $_POST["student_number"]);
                /* execute query */
